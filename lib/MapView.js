...
class MapView extends React.Component {
    ...
    setNativeProps(props) {
        var _a;
        // @ts-ignore
        (_a = this.map.current) === null || _a === void 0 ? void 0 : _a.setNativeProps(props);
    }
    _onMapReady() {
    ...
    animateCamera(camera, opts) {
        if (this.map.current) {
            MapViewNativeComponent_1.Commands.animateCamera(this.map.current, camera, (opts === null || opts === void 0 ? void 0 : opts.duration) ? opts.duration : 500);
        }
    }
    ...
    render() {
        ...
        if (this.state.isReady) {
            props = Object.assign({ region: null, initialRegion: null, onChange: this._onChange, onMapReady: this._onMapReady, liteMode: this.props.liteMode, googleMapId: this.props.googleMapId, googleRenderer: this.props.googleRenderer, ref: this.map, customMapStyleString: this.props.customMapStyle
