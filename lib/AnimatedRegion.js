...
class AnimatedMapRegion extends AnimatedWithChildren {
    ...
    spring(config) {
        ...
        for (const type of configTypes) {
            if (config.hasOwnProperty(type)) {
                animations.push(react_native_1.Animated.spring(this[type], Object.assign(Object.assign({}, config), { toValue: config[type], 
                    // may help to eliminate some dev warnings and perf issues
                    useNativeDriver: !!(config === null || config === void 0 ? void 0 : config.useNativeDriver) })));
            }
        }
    ...
    timing(config) {
        ...
        for (const type of configTypes) {
            if (config.hasOwnProperty(type)) {
                animations.push(react_native_1.Animated.timing(this[type], Object.assign(Object.assign({}, config), { toValue: config[type], 
                    // may help to eliminate some dev warnings and perf issues
                    useNativeDriver: !!(config === null || config === void 0 ? void 0 : config.useNativeDriver) })));
            }
        }
