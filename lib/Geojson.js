...
const Geojson = (props) => {
    ...
    return (<React.Fragment>
      {pointOverlays.map((overlay, index) => {
            ...
            const pointOverlayTracksViewChanges = ((_a = overlay.feature.properties) === null || _a === void 0 ? void 0 : _a.tracksViewChanges) || tracksViewChanges;
...
const makePointOverlays = (features) => {
    return features
        ...
        .map(overlay => (Object.assign(Object.assign({}, overlay), { type: 'point' })));
};
const makeLineOverlays = (features) => {
    return features
        ...
        .reduce((prev, curr) => prev.concat(curr), [])
        .map(overlay => (Object.assign(Object.assign({}, overlay), { type: 'polyline' })));
};
const makePolygonOverlays = (features) => {
    const multipolygons = features
        ...
        .reduce((prev, curr) => prev.concat(curr), [])
        .map(overlay => (Object.assign(Object.assign({}, overlay), { type: 'polygon' })));
...
const getColor = (prop, overlay, colorType) => {
    ...
    let color = (_a = overlay.feature.properties) === null || _a === void 0 ? void 0 : _a[colorType];
    if (color) {
        const opacityProperty = colorType + '-opacity';
        const alpha = (_b = overlay.feature.properties) === null || _b === void 0 ? void 0 : _b[opacityProperty];
...
const getStrokeWidth = (prop, overlay) => {
    ...
    return (_a = overlay.feature.properties) === null || _a === void 0 ? void 0 : _a['stroke-width'];
};
